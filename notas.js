 ...
 // criou a variavel e selecionou essa opção "document" para puxar algo do html
 // e "querySelector" para selecionar o que do html (no caso a linha 22 'h1' que é o título) // 
 
 let titulo = document.querySelector('h1');
titulo.innerHTML = 'Jogo do Número Maluco';
// essa opção innerHTML (significa dentro do HTML, nesse caso, ficou meio que "o título dentro do html será: texto em aspas)
 

 // Aqui vamos colocar um paragrafo abaixo do titulo com a escrita.
let paragrafo = document.querySelector('p');
paragrafo.innerHTML = 'Tente adivinhar um número entre 1 e 10';


// na linha 27 do HTML tem essa opção <button onclick="verificarChute()" class="container__botao">Chutar</button>
// Esse verificarChute() eu que adicionei para criar uma função.
function verificarChute() {
    console.log('apertaram e tal')
}
